...
describe('resource paymentTerms', () => {
  test('retrieve', async () => {
    const responsePromise = client.finance.paymentTerms.retrieve('id');
  ...
  test('update', async () => {
    const responsePromise = client.finance.paymentTerms.update('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete', async () => {
    const responsePromise = client.finance.paymentTerms.delete('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
