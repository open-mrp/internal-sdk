...
describe('resource batches', () => {
  test('create: only required params', async () => {
    const responsePromise = client.operations.productionRuns.batches.create('id', {
      batches: [
        {
  ...
  test('create: required and optional params', async () => {
    const response = await client.operations.productionRuns.batches.create('id', {
      batches: [
        {
          item_id: 'it_01jm4r6700f8nwq3v5hx2d9ktp',
          production_step_id: 'prst_01jm4r6700f8nwq3v5hx2d9ktp',
  ...
  test('list', async () => {
    const responsePromise = client.operations.productionRuns.batches.list('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
