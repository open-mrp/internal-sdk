...
describe('resource attributes', () => {
  test('create: only required params', async () => {
    const responsePromise = client.catalog.properties.attributes.create('', { sort_order: 1, value: 'Red' });
  ...
  test('create: required and optional params', async () => {
    const response = await client.catalog.properties.attributes.create('', {
      sort_order: 1,
      value: 'Red',
      color: 'red',
    });
  ...
  test('update: only required params', async () => {
    const responsePromise = client.catalog.properties.attributes.update('', { property_id: '' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('update: required and optional params', async () => {
    const response = await client.catalog.properties.attributes.update('', {
      property_id: '',
      color: 'blue',
      sort_order: 0,
      value: 'Blue',
