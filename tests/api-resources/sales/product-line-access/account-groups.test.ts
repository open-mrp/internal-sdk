...
describe('resource accountGroups', () => {
  test('retrieve', async () => {
    const responsePromise = client.sales.productLineAccess.accountGroups.retrieve('account_group_id');
  ...
  test('update', async () => {
    const responsePromise = client.sales.productLineAccess.accountGroups.update('account_group_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete', async () => {
    const responsePromise = client.sales.productLineAccess.accountGroups.delete('account_group_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
