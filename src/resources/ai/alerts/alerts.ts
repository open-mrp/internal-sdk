...
import * as RunsActionsAPI from '../runs/actions';
...
export class Alerts extends APIResource {
  ...
  ): APIPromise<ActionsAPI.AgentAlert> {
...
export interface AgentAction {
   ...
   * Agent run resource.
   */
  run: RunsActionsAPI.AgentRun | null;
...
export interface AgentAlert {
   ...
   * Reference to an actor (user, API key, or agent).
   */
  acknowledged_by: ShipmentsActionsAPI.Actor | null;

  /**
   * Agent action resource.
   */
  action: RunsActionsAPI.AgentAction | null;
...
export interface AgentDefinition {
   ...
   */
  config: RunsActionsAPI.AgentDefinitionConfig | null;
   ...
   */
  tools: RunsActionsAPI.ListAgentDefinitionTool | null;
...
export interface AgentDefinitionConfig {
   ...
   */
  trigger_config: RunsActionsAPI.TriggerConfig | null;
}
...
export interface AgentDefinitionTool {
   ...
   */
  tool: RunsActionsAPI.AvailableTool;
}
...
export interface AgentRun {
   ...
   * List represents a paginated list of resources.
   */
  actions: RunsActionsAPI.ListAgentAction | null;
   ...
   * Agent definition resource.
   */
  definition: RunsActionsAPI.AgentDefinition | null;
   ...
   * List represents a paginated list of resources.
   */
  steps: RunsActionsAPI.ListAgentRunStep | null;
...
export interface ListAgentAction {
   ...
   */
  data: Array<RunsActionsAPI.AgentAction>;
...
export interface ListAgentAlert {
   ...
   * Resources in this page.
   */
  data: Array<ActionsAPI.AgentAlert>;
...
export interface ListAgentDefinitionTool {
   ...
   * Resources in this page.
   */
  data: Array<RunsActionsAPI.AgentDefinitionTool>;
...
export interface ListAgentRunStep {
   ...
   * Resources in this page.
   */
  data: Array<RunsActionsAPI.AgentRunStep>;
