...
export class PurchaseOrders extends APIResource {
  ...
  ): APIPromise<ActionsAPI.PurchaseOrderDetail> {
...
export interface ListEmailContact {
   ...
   * Resources in this page.
   */
  data: Array<ActionsAPI.EmailContact>;
...
export interface PurchaseOrderDetail {
   ...
   * List represents a paginated list of resources.
   */
  contacts: ActionsAPI.ListEmailContact | null;
   ...
   * List represents a paginated list of resources.
   */
  lines: ActionsAPI.ListPurchaseOrderLineDetail | null;
   ...
   */
  receiving_order: ActionsAPI.ReceivingOrder | null;
   ...
   */
  supplier: ActionsAPI.Supplier | null;
