...
export class Actions extends APIResource {
   ...
   * ```
   */
  ship(id: string, params: ActionShipParams, options?: RequestOptions): APIPromise<ShipmentDetail> {
   ...
   * ```
   */
  void(id: string, options?: RequestOptions): APIPromise<ShipmentDetail> {
...
export interface PickDetail {
   ...
   * Full sales order resource.
   */
  sales_order: SalesOrderDetail | null;
...
export interface TransactionDetail {
   ...
   * Account user with profile, role, and department.
   */
  responsible_user: AccountUser | null;
