...
export class Actions extends APIResource {
   ...
   * ```
   */
  pick(id: string, options?: RequestOptions): APIPromise<ShipmentsActionsAPI.PickDetail> {
   ...
   * ```
   */
  void(id: string, options?: RequestOptions): APIPromise<ShipmentsActionsAPI.PickDetail> {
