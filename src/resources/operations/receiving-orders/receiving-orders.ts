...
import * as ActionsAPI from '../purchase-orders/actions';
import * as ReceivingOrdersActionsAPI from './actions';
import {
  ActionStockParams,
  Actions,
  AllocationRequest,
...
import * as ReceivingOrdersLinesAPI from './lines/lines';
...
export class ReceivingOrders extends APIResource {
  actions: ReceivingOrdersActionsAPI.Actions = new ReceivingOrdersActionsAPI.Actions(this._client);
  lines: ReceivingOrdersLinesAPI.Lines = new ReceivingOrdersLinesAPI.Lines(this._client);
   ...
   * ```
   */
  retrieve(id: string, options?: RequestOptions): APIPromise<ActionsAPI.ReceivingOrder> {
...
export interface ListReceivingOrderLine {
   ...
   * Resources in this page.
   */
  data: Array<ActionsAPI.ReceivingOrderLine>;
...
export interface ReceivingOrder {
   ...
   * List represents a paginated list of resources.
   */
  lines: ActionsAPI.ListReceivingOrderLine | null;
   ...
   * Account with optional branding and portal sub-resources.
   */
  supplier: LinesAPI.Account | null;
...
export interface ReceivingOrderLine {
   ...
   * Value with an associated unit.
   */
  rejected_quantity: LinesAPI.Quantity | null;
