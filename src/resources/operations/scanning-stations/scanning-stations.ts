...
import * as ScanningStationsActionsAPI from './actions';
import {
  ActionBulkUpsertParams,
  ActionExportParams,
  Actions,
  BulkUpsertScanningStationsRequest,
  ExportScanningStationsRequest,
  UpsertScanningStationInput,
} from './actions';
...
export class ScanningStations extends APIResource {
  actions: ScanningStationsActionsAPI.Actions = new ScanningStationsActionsAPI.Actions(this._client);
...
ScanningStations.Actions = Actions;
