...
export interface InventoryReceiptSummaryEntry {
   ...
   */
  holder_account: AccountUsersAPI.Entity | null;
   ...
   * Entity is a polymorphic reference to any resource in the system.
   */
  location: AccountUsersAPI.Entity | null;
   ...
   * Entity is a polymorphic reference to any resource in the system.
   */
  owner_account: AccountUsersAPI.Entity | null;
...
export interface ProductionCostItem {
   ...
   * Entity is a polymorphic reference to any resource in the system.
   */
  category: AccountUsersAPI.Entity | null;

  /**
   * Entity is a polymorphic reference to any resource in the system.
   */
  department: AccountUsersAPI.Entity | null;
...
export interface WeeksOfSalesItem {
   ...
   * Entity is a polymorphic reference to any resource in the system.
   */
  product_line: AccountUsersAPI.Entity | null;
