...
export class Transactions extends APIResource {
   ...
   * ```
   */
  create(body: TransactionCreateParams, options?: RequestOptions): APIPromise<ActionsAPI.TransactionDetail> {
  ...
  ): APIPromise<ActionsAPI.TransactionDetail> {
   ...
   * ```
   */
  delete(id: string, options?: RequestOptions): APIPromise<ActionsAPI.TransactionDetail> {
